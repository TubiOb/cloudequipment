...
const AboutUs = () => {
  return (
    <div className='w-full h-auto flex flex-wrap flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row items-center justify-between gap-8 lg:gap-2 bg-white py-[10%] px-[5%] lg:py-[18%] lg:px-[13%]'>
        <img src={Image} alt="Couple of staffs smiling" />
        <div className='lg:w-[40%] flex items-start justify-between flex-col gap-4 lg:gap-10 py-3 px-1'>
            ...
            <h2 className="font-['Playfair Display'] play font-bold lg:leading-[80px] text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl">Diversify your wealth to help grow the medical sector</h2>
