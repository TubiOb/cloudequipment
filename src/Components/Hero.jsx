...
import baseImage from '../assets/Base-img-1.png'
        ...
        <div className='bg-neutral-200/15 absolute top-0 left-0 w-full h-screen'>
            <div className='absolute top-0 md:-top-8 lg:top-0 xl:top-0 2xl:top-0 w-full h-full flex flex-col justify-center text-white'>
                <div className='md:left-[8%] max-w-[600px] xl:max-w-[40%] 2xl:max-w-[45%] m-auto absolute p-4'>
                    ...
                    <div className='flex items-start justify-between 2xl:w-[70%] xl:w-[65%] md:w-[55%] w-[70%] md:gap-1 xl:gap-2.5 2xl:gap-4 mt-2 2xl:mt-4'>
