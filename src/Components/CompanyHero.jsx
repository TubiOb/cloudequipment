...
import baseImage from '../assets/Base-img-2.svg'
...
const CompanyHero = () => {
  return (
    <div className='w-full h-[600px] lg:h-1/5'>
        ...
        <div className='bg-neutral-200/5 absolute top-0 left-0 w-full h-screen'>
            <div className='absolute top-0 w-full h-full flex flex-col items-center justify-center text-white'>
                <div className='max-w-[600px] xl:max-w-[40%] 2xl:max-w-[45%] m-auto absolute p-4'>
                    ...
                    <h1 className="2xl:text-5xl xl:text-3xl md:text-2xl text-xl font-medium leading-9 2xl:leading-[80px] xl:leading-[72px] md:leading-[60px] font-['Roboto'] roboto drop-shadow-2xl">Buy/Rent Medical Equipments from our Market place</h1>
