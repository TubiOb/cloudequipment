...
const CompanyFeatures = () => {
  return (
    <div className='flex w-full h-full mb-64 items-center mt-32 md:mt-[250px] lg:mt-[750px]'>
        <div className='flex flex-col items-center justify-center w-[80%] mx-auto relative gap-20'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 items-center lg:items-start justify-between w-[90%] mx-auto gap-6'>
                <div className='grid grid-cols-1 items-start justify-between mx-auto w-[90%] md:w-[70%] lg:w-[55%] xl:w-[65%] gap-8 py-3'>
                ...
                <div className=' items-end mx-auto w-[90%] pt-28 md:w-[70%] lg:w-[60%] lg:h-[150px]'>
                    <img src={Doc} alt="" className='self-end' />
                </div>
            </div>
        </div>
    </div>
