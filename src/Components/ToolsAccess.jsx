    ...
    <div className='w-full flex-col flex items-center mb-24 lg:items-start gap-20'>
        <div className='flex flex-col xl:flex-row items-center justify-between gap-3 p-4'>
            ...
            <div className='flex flex-col items-start justify-center p-4 lg:px-48 gap-4'>
                <h4 className='play font-extrabold leading-9 tracking-tight text-4xl'>Powerful tools.</h4>
                <h4 className='play font-extrabold leading-9 tracking-tight text-4xl text-[#54D4BD]'>More control.</h4>
        ...
        <div className='flex flex-col xl:flex-row items-center justify-between gap-3 p-4'>
            <div className='flex flex-col items-start justify-center p-4 lg:px-48 gap-4'>
                <h4 className='play font-extrabold leading-9 tracking-tight text-4xl'>Increasing Access to Quality</h4>
                <h4 className='play font-extrabold leading-9 tracking-tight text-4xl text-[#54D4BD]'>Mlife-saving machines</h4>
